...
/**
 * \brief The Timestamp type represents a positive time with respect to the
 * epoch
 */
typedef struct {
#define OPERATE(name, size, type) type name;
...
/**
 * \brief The TimePropertiesDS type represent time source and traceability
...
/**
 * \brief The PTPText data type is used to represent textual material in PTP
 * messages
 */
typedef struct {
#define OPERATE(name, size, type) type name;
...
/**
 * \brief Management TLV Unicast Negotiation Enable fields (Table 73 of the
 * spec)
 */
/* Management TLV Traceability Properties Message */
typedef struct {
...
/**
 * \brief Management TLV Log Min Pdelay Req Interval fields (Table 66 of the
 * spec)
 */
...
/**
 * \brief Signaling TLV Request Unicast Transmission fields (Table 73 of the
 * spec)
 */
...
/**
 * \brief Signaling TLV Cancel Unicast Transmission fields (Table 75 of the
 * spec)
 */
...
/**
 * \brief Signaling TLV Acknowledge Cancel Unicast Transmission fields (Table 76
 * of the spec)
 */
...
typedef struct {
  ...
  UInteger8
      localPreference;   /* local preference - only used by telecom profile */
